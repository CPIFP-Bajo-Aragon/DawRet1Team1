...
function showPassField(){
    ...
    var div = document.getElementById('passFields');
...
function validarFormulario(e){ /*Bien*/
    switch (e.target.name) {
        ...
        break;
        case "newclave":
            validarCampo(expresiones.clave, e.target, 'newclave');
            validarPass();
        break;
		case "email":
...
function validarCambioPass(){
	...
	if(campos.newClave && campos.clave1){
        newClave = false;
        clave1 = false;
        return true;
	} else {
		document.getElementById('formulario__cambioPass').classList.add('mensaje-activo');
        return false;
	}
}
...
function validarPass() {
    ...
    if(document.getElementById('newclave').value == document.getElementById('newclaveconf').value){
		document.getElementById(`grupo__newclaveconf`).classList.remove('formulario__grupo-incorrecto');
		document.getElementById(`grupo__newclaveconf`).classList.add('formulario__grupo-correcto');
		document.querySelector(`#grupo__newclaveconf i`).classList.add('fa-check-circle');
		document.querySelector(`#grupo__newclaveconf i`).classList.remove('fa-times-circle');
		document.querySelector(`#grupo__newclaveconf .input-error`).classList.remove('input-error-activo');
		campos[newClave] = true;
	} else {
		document.getElementById(`grupo__newclaveconf`).classList.add('formulario__grupo-incorrecto');
		document.getElementById(`grupo__newclaveconf`).classList.remove('formulario__grupo-correcto');
		document.querySelector(`#grupo__newclaveconf i`).classList.add('fa-times-circle');
		document.querySelector(`#grupo__newclaveconf i`).classList.remove('fa-check-circle');
		document.querySelector(`#grupo__newclaveconf .input-error`).classList.add('input-error-activo');
