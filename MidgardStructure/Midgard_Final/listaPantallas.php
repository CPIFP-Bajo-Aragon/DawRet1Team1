...
<body>
    ...
    <form class="buscador" action="listaPantallas.php" method="get">
        <button type="button" onclick="cambiarContenido(listaIconos, listaTabla)"><i class="fa-solid fa-list fa-2x"></i></button>   
        <input type="text" id="palabra" name="palabra" placeholder="Buscador">
        <button type="submit" name="search" id="search" title="Buscar"><i id="lupa" class="fas fa-search"></i></button>
        <!-- <input type="submit" name="todas" id="todas" value="MostrarTodasPantallas" /> -->
        <button type="submit" name="todas" id="todas"><i class="fa fa-refresh fa-2x" aria-hidden="true"></i></button>  
    </form>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body"> 
                    ...
                    <label for="mac" class="form-label mt-2">Dirección MAC</label>
                        <div class="grupo-input" id="input__mac">
                            <input type="text" class="form-control" id="macEdit" name="mac" placeholder="a1:b2:c3:d4:e5:f6" maxlength="17" style="text-transform: uppercase" readonly>
                            <i class="validacion-estado fas fa-times-circle"></i>
                        </div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-success" name="pantaButtonEdit">Guardar</button>
