...
<body>
    ...
    <nav id="menu" class="navbar navbar-expand-lg navbar-dark">
        <div class="container-fluid ">
            ...
            <ul id="menu2" class="navbar-nav">
                ...
                <li id="listaU" class="nav-item"> <!-- LISTA USUARIOS -->
                ...
                <?php if ($_SESSION["rol"]=='1'): ?>
                <li id="listaP" class="nav-item"> <!-- LISTA PANTALLAS -->
    ...
    <form action="listaPublicaciones.php" method="get">
        ...
        <button type="submit" name="search" id="search" title="Buscar"><i class="fas fa-search"></i></button>
        <buttom type="submit" name="todas" id="todas"><i class="fa fa-refresh fa-2x" aria-hidden="true"></i></buttom>     
    </form>
        ...
        <div class="row" style="display:" id="listaIconos">
            <?php
                ...
                if ($_SESSION["rol"]=='1'){
                    ...
                    $consulta="SELECT id_publicacion, titulo, id FROM PUBLICACION WHERE id='2'";
                }
        ...
        <div class="row" style="display:none" id="listaTabla">
            <?php
                ...
                if ($_SESSION["rol"]=='1'){
                    ...
                    $consulta="SELECT * FROM PUBLICACION WHERE id='2'";
                }
            ...
            <div class="modal-content">
                ...
                <?php endif; ?>
                    ...
                    <textarea id=mensaje name="mensaje"
                     class="form-control"cols="3" rows="3" maxlength="2300"></textarea>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-success" name="publiButtonEdit">Guardar</button>
                </div>
                </form>
            </div>
        </div>
