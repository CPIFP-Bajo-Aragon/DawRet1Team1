...
<body>
    ...
    <section class="container-fluid contenedor">
        <div class="navegador-carrusel d-flex justify-content-center align-items-center mt-2 mb-2">
            <div class="menuCarrusel">
                <button onclick="prev()">
                                        ...
                                        <div class="carousel-item active">
                                            <div class="txtimg">
                                                <div class="txtimg-img d-flex justify-content-center align-items-center">
                                                    <img src="img/userImage/<?php echo $mensaje['imagen'] ?>" class="img-fluid" alt="..."> <br>    
                                                </div>
